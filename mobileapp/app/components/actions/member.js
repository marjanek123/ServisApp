...
export const getMembers = () => (dispatch, getState) => {
    ...
    axios
        .get(`http://${HOST}/api/member-list/`, tokenConfig(getState))
        .then((res) => {
            dispatch({
                type: GET_MEMBERS,
                payload: res.data,
...
export const updateMembers = (permissions, id) => (dispatch, getState) => {
    ...
    axios
        .put(`http://${HOST}/api/member-detail/${id}/`, conn, tokenConfig(getState))
        .then((res) => {
            dispatch({
                type: UPDATE_MEMBER,
                payload: res.data,
...
export const getInviteList = () => (dispatch, getState) => {
    ...
    axios
        .get(`http://${HOST}/api/invite-list/`, tokenConfig(getState))
        .then((res) => {
            dispatch({
...
export const acceptInviteDetail = (id) => (dispatch, getState) => {
    ...
    axios.patch(
        `http://${HOST}/api/invite-detail/${id}/ `,
        is_accepted,
...
export const searchUsers = (search) => (dispatch, getState) => {
    ...
    axios
        .get(`http://${HOST}/api/userlist?search=${search}`, tokenConfig(getState))
        .then((res) => {
            dispatch({
                type: GET_USERS_LIST,
                payload: res.data,
